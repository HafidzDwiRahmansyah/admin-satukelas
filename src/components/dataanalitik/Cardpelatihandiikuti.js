...
export default function Cardpelatihandiikuti() {
    ...
    useEffect(() => {
        fetch("/api/data")
            ...
            .then((data) => setData(data.pelatihanyangdiikuti))
    ...
    return (
        <section className="p-4">
            <h2 className="poppins-semibold py-2 fs-16">Pelatihan yang diikuti</h2>
                ...
                <table className="w-full my-4">
                    <thead>
                        <tr className="border-b border-gray-400 py-2">
                            ...
                            <th className="text-left px-4 py-2">Judul Course</th>
                            <th className="text-left px-4 py-2">Waktu Pendaftaran</th>
                    ...
                    <tbody>
                        {currentData.map((item, index) => (
                            <tr key={item.id} className={index % 2 === 0 ? 'bg-blue-50' : 'bg-white'}>
                                ...
                                <td className="px-4 py-2">{renderStatus(item.progres)}</td>
