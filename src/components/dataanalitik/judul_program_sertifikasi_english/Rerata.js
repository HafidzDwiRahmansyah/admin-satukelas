    ...
    return (
        <div className="card bg-white shadow rounded-md p-4" style={{ width: "280px"}}>
            <div className="card-body">
                ...
                <p className="fs-12 poppins-regular text-gray-400">Waktu dihitung sejak peserta memencet tombol mulai pelatihan, dan selesai ketika lulus ujian dan berhak mendapatkan sertifikat.</p>
            </div>
        </div>
    )
}