...
import Tambahmateri from '@/components/Modal/Tambahmateri';
...
export default function Editpelatihan() {
    ...
    return (
        <div className="card bg-white w-full rounded-md p-4">
            <h2 className="poppins-semibold">Buat Data Pelatihan</h2>
            <p className="text-gray-400 poppins-regular">Isi formulir di bawah Untuk Menambahkan Pelatihan Internal. Anda Dapat Menugaskan Pelatihan ini ke Karyawan.</p>
            <div className="form-group py-4">
                <label className="block text-gray-700 mb-2">Judul Pelatihan <span className="text-red-500">*</span></label>
                <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Masukan Judul Pelatihan" />
            </div>
            ...
            <div className="form-group py-4">
                ...
                <textarea type="text" rows="6" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Masukan Deskripsi Pelatihan"
                ></textarea>
            </div>
            <div className="form-group py-4">
                <label className="block text-gray-700 mb-2">Ringkasan <span className="text-gray-400">(Opsional)</span></label>
                <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Masukan Ringkasan Pelatihan" />
            </div>
            ...
            <div className="form-group py-4">
                ...
                <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="[default isi ini sebagai Nama Perusahaan]" />
            </div>
            <div className="form-group py-4">
            ...
            <div className="form-group py-4">
                <label className="block text-gray-700 mb-2 poppins-semibold">Tambah Materi <span className="text-gray-500">(Opsional)</span></label>
                <div className="flex py-4 justify-end">
                    <button
                        className="bg-blue-500 hover:bg-blue-700 text-white poppins-semibold py-2 px-4 rounded-md"
            ...
            <div className="flex justify-end gap-4">
                <button className="poppins-semibold py-2 px-4 text-blue-500 border border-blue-500 rounded-md">Kembali</button>
                <button className="poppins-semibold py-2 px-4 bg-blue-500 text-white rounded-md">Simpan Sebagai Draft</button>
                <button className="poppins-semibold py-2 px-4 bg-blue-500 text-white rounded-md">Publish</button>
            </div>
        </div>
    )
}