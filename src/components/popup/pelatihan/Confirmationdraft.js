                ...
                <div
                    ...
                    <div
                        ...
                        <h2 className="text-xl poppins-bold text-gray-800 pt-6">
                            Apakah Anda Yakin untuk Menyimpan Pelatihan sebagai Draft ?
                        </h2>
                        <p className="text-gray-600 poppins-regular fs-14 mx-6 my-2">
                            Anda akan menyimpan pelatihan
                            <span className="poppins-semibold"> Judul Pelatihan </span> sebagai draft
                        </p>
