                                ...
                                <div className="flex grid grid-cols-2 gap-14">
                                    ...
                                    <div className="flex-col cols-2">
                                        ...
                                        <div className="form-group py-4">
                                            ...
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Adhi Prasetyo" />
                                        </div>
                                        <div className="form-group py-4">
                                        ...
                                        <div className="form-group py-4">
                                            ...
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="085768493045" />
                                        </div>
                                    </div>
                                    <div className="flex-col cols-2">
                                    ...
                                    <div className="flex-col cols-2">
                                        <div className="form-group py-4">
                                            ...
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Jalan Kenari No.49" />
                                        </div>
                                        <div className="form-group py-4">
                                    ...
                                    <div className="flex-col cols-2">
                                        <div className="form-group py-4">
                                            ...
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Staff" />
                                        </div>
                                        <div className="form-group py-4">
                                            <label className="block text-gray-700 mb-2 poppins-semibold">Divisi <span className="text-red-500">*</span></label>
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Tax Learning" />
                                        </div>
                                    </div>
                                    <div className="flex-col cols-2">
                                    ...
                                    <div className="flex-col cols-2">
                                        <div className="form-group py-4">
                                            ...
                                            <input type="text" className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="adhi@satukelas@.com" />
                                        </div>
                                        <div className="form-group py-4">
